      ...
      <div className="relative z-10 flex flex-col items-center gap-8">
        ...
        <div className="splash-icon-ring">
          <div className="splash-icon-ring-inner">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              className="w-10 h-10 splash-icon-pulse"
        ...
        <div className="flex flex-col items-center gap-2">
          <h1 className="text-4xl font-black tracking-[-0.05em] text-white splash-title">
            PERFECT
            <span className="bg-gradient-to-r bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(to right, var(--accent), var(--accent-hover), var(--accent))' }}> TRANSLATOR</span>
          </h1>
